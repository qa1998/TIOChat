...
/// 群聊历史消息响应
FOUNDATION_EXPORT TIOCmdKey const TioCmdRoomHistoryMessagesResp;

FOUNDATION_EXPORT TIOCmdKey const TioCmdRoomOperNtf;

FOUNDATION_EXPORT TIOCmdKey const TioCmdRoomChatNtf;
...
FOUNDATION_EXPORT TIOCmdKey const WxCallOUAnswerNtf;
FOUNDATION_EXPORT TIOCmdKey const WxCallOUCallNtf;
